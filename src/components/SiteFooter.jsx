export default function SiteFooter() {
  return (
    <footer className="bg-ink text-porch-pale/70 text-sm">
      <div className="max-w-5xl mx-auto px-6 py-10 grid gap-8 sm:grid-cols-3">
        <div>
          ...
          <p>
            <a className="underline hover:text-porch-pale" href="mailto:info@enjoysenoia.com">
              info@enjoysenoia.com
            </a>
          </p>
          <p>
            <a className="underline hover:text-porch-pale" href="tel:+17707279173">(770) 727-9173</a>
          </p>
        ...
        <div>
          ...
          <p>Sunday, September 6, 2026 · music starts at 3pm</p>
      ...
      <p className="text-center pb-6 text-porch-pale/70">
        Senoia PorchFest
      </p>
    </footer>
  )
